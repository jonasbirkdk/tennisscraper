...
def brooks():
    ...
    pw=os.getenv("lta_pw")
    url = 'https://clubspark.lta.org.uk/BrookGreenTennis'
    ...
    time.sleep(4)
    driver.find_element(By.XPATH, "//*[@id=\"content\"]/div[1]/div/div/div/ul/li[4]/a").click()
    ...
    while current_date < end_date:
        ...
        for tag in free_tags:
            price_tag = tag.parent.find('span', class_="cost").text
            if price_tag == "Free":
                continue
        ...
        driver.find_element(By.XPATH, '//*[@id="book-by-date-view"]/div/div[1]/div/div[1]/a[3]').click()
